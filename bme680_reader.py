...
# ============================================
TEMP_OFFSET = 0.0  # 温度オフセット（℃）- 2026-01-21リセット（M5Stack比較検証用）
HUMIDITY_OFFSET = 0.0  # 湿度オフセット（%RH）- 2026-01-21リセット（M5Stack比較検証用）
PRESSURE_OFFSET = 0.0  # 気圧オフセット（hPa）- 2026-01-21リセット（M5Stack比較検証用）
